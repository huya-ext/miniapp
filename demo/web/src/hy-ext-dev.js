...
class HyExtDev extends React.Component {
  ...
  log1 (msg) {
    this.setState({
      log1: [...this.state.log1, { msg, time: new Date() }]
    })
  }
  log2 (msg) {
    this.setState({
      log2: [...this.state.log2, { msg, time: new Date() }]
    })
  }
  log3 (msg) {
    this.setState({
      log3: [...this.state.log3, { msg, time: new Date() }]
    })
  }
  log4 (msg) {
    this.setState({
      log4: [...this.state.log4, { msg, time: new Date() }]
    })
  }
  log5 (msg) {
    this.setState({
      log5: [...this.state.log5, { msg, time: new Date() }]
    })
  }
  log6 (msg) {
    this.setState({
      log6: [...this.state.log6, { msg, time: new Date() }]
    })
  }
  log7 (msg) {
    this.setState({
      log7: [...this.state.log7, { msg, time: new Date() }]
    })
  }
  log8 (msg) {
    this.setState({
      log8: [...this.state.log8, { msg, time: new Date() }]
    })
  }
  log9 (msg) {
    this.setState({
      log9: [...this.state.log9, { msg, time: new Date() }]
    })
  }
