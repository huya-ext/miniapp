...
1. 前往[开发者中心](https://ext.huya.com/)创建小程序
...
3. 使用[开发者工具](https://github.com/huya-ext/miniapp/wiki/%E8%84%9A%E6%89%8B%E6%9E%B6)开发完毕并测试通过后即可提交审核
...
小程序发布后主播就可以在应用商店中查看并安装它，观众访问主播的直播间时就可以看到该小程序啦，主播和观众即可通过小程序进行互动。
